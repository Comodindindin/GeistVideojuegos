...
public class cerrarvideomenu2 : MonoBehaviour
{
    private VideoPlayer videos;       // Componente VideoPlayer
    private int numeroEscena = 17;    // Índice de la escena a cargar (definido directamente en el código)

    private void Awake()
    {
        // Obtener automáticamente el componente VideoPlayer
